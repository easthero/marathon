...
#显示表单
include("header.php");
$form = new PFBC\Form("admin");
$form->addElement(new PFBC\Element\Hidden("form", "admin"));
$form->addElement(new PFBC\Element\HTML('<legend>请输入密码</legend>'));
$form->addElement(new PFBC\Element\Password("密码:", "Password", array(
        "required" => 1,
        "validation" => new PFBC\Validation\RegExp("/^c2tm4r4th0n2014$/",
        "Error: 密码错误，请重新输入"),
)));
